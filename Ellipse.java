...
public class Ellipse
{
     ...
     * @param centerY the y coordinate of the center of the ciellipsercle.
     * @param width the width of the ellipse in pixels.
     * @param height the height of the ellipse in pixels.
     * @param color the color of the ellipse. Valid colors are "red", "yellow", "blue", "green",
     * "magenta" and "black".
     * 
     */
    public Ellipse(int centerX, int centerY, int height, int width, String color)
    {
        this.width = width;
        this.height = height;
