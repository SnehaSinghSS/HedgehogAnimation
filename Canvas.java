...
public class Canvas
{
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red")) {
            ...
            graphic.setColor(new Color(255, 150, 100));
        }
         else if(colorString.equals("brown")) {
            graphic.setColor(new Color(150,70,20)); 
        }
        else if(colorString.equals("gray")) {
            graphic.setColor(new Color(169,169,169)); 
        }
        else if(colorString.equals("very light gray")) {
            graphic.setColor(new Color(210,210,210)); 
        }
        ...
        else if(colorString.equals("very dark gray")) {
